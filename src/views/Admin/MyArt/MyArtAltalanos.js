...
const MyArtAltalanos = (props) => {
  ...
  const [myArtAltalanosObj, setMyArtAltalanosObj] = useState(
    defaultMyArtAltalanosObj
  );
      ...
      >
        <ModalHeader>
          {!currentId
            ...
            : "MyArt általános bejegyzés módosítása"}
        </ModalHeader>
        <ModalBody>
          <div className="col-md-12">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange(e, myArtAltalanosObj, setMyArtAltalanosObj)
              }
            />
          </div>
          <div className="col-md-12">
          ...
          <div className="col-md-12">
            <Label>Leiras:</Label>
            <Wysiwyg
              fontId="myArtAltalanos"
              onChange={onChangeEditor}
              value={myArtAltalanosObj.leiras}
            />
          </div>
        </ModalBody>
        <ModalFooter>
