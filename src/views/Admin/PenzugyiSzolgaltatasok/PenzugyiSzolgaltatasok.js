...
const PenzugyiSzolgaltatasok = (props) => {
  ...
  const [penzugyiSzolgObj, setPenzugyiSzolgObj] = useState(
    defaultPenzugyiSzolgObj
  );
  ...
  const MyDropzone = () => {
    ...
    return (
      <React.Fragment>
        <div
          hidden={penzugyiSzolgObj.kep.length > 0}
      ...
      >
        <ModalHeader>
          {!currentId
            ...
            : "Pénzügyi szolgaltatas módosítása"}
        </ModalHeader>
        <ModalBody>
          <div className="col-md-12">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange(e, penzugyiSzolgObj, setPenzugyiSzolgObj)
              }
            />
          </div>
          <div className="col-md-12">
        ...
        <ModalFooter>
          <Button
            color="success"
            onClick={() =>
              serializeValue("se", penzugyiSzolgObj, () => {}, "leiras", onSave)
            }
          >
            Mentés
          </Button>
