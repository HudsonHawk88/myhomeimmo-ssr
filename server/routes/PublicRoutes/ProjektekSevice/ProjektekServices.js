...
router.get('/', async (req, res) => {
    ...
    if (id) {
        ...
        const sql = `SELECT id, nev, leiras, penznem, borito, utem, szlogen, felirat, bemutatvideo, cim, atadasev, atadasnegyedev, atadashonap, osszlakasszam, szabadlakasszam, projektingatlanok, ingtipus, elsodlegesfutes, masodlagosfutes, harmadlagosfutes, parkolotipus, parkolohasznalat, parkoloarmill,isTobbEpuletes, komfort, epuletszintek, isLift, tarolohasznalat, isAkadalymentes, isLegkondicionalt, isZoldOtthon, energetika, isNapelemes, isSzigetelt, szigetelesmeret, isPublikus FROM projektek;`;
