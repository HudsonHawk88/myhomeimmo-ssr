                      ...
                      <div className="row">
                        ...
                        <div className="col-md-12">
                          <Label>
                            Az{" "}
                            <a
                              href="https://www.myhomeimmo.hu/adatkezeles"
                              target="_blank"
                            >
                              adatkezelési tájékoztatót
                            </a>{" "}
                            megismertem, és hozzájárulok az abban rögzített
                            adatkezelési célokból történő adatkezeléshez: *
                          </Label>
                          <Input
                            type="checkbox"
                        ...
                        <div className="col-md-12">
                          ...
                          <span className="recaptcha_text">
                            Ez az oldal védve van a Google reCAPTCHA-val és
                            érvényesek rá a Google{" "}
