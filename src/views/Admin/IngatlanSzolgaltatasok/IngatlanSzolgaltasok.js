...
const IngatlanSzolgaltatasok = (props) => {
  ...
  const MyDropzone = () => {
    ...
    return (
      <React.Fragment>
        <div
          hidden={ingatlanSzolgObj.kep && ingatlanSzolgObj.kep.length > 0}
      ...
      >
        <ModalHeader>
          {!currentId
            ...
            : "Ingatlan szolgaltatas módosítása"}
        </ModalHeader>
        <ModalBody>
          <div className="col-md-12">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange(e, ingatlanSzolgObj, setIngatlanSzolgObj)
              }
            />
          </div>
          <br />
