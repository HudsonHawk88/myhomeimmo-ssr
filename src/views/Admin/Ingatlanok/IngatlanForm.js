...
const IngatlanForm = (props) => {
  ...
  useEffect(() => {
    const altipus = altipusOptions.find(
      (altyp) =>
        altyp.tipus_id === parseInt(ingatlanObj.tipus, 10) ||
        altyp.tipus_id === ingatlanObj.tipus
    );
    if (!altipus) {
      setIngatlanObj({
        ...ingatlanObj,
  ...
  return (
    <RVForm onSubmit={onSubmit} encType="multipart/form-data" noValidate={true}>
      ...
      <ModalHeader>
        {!currentId
          ? "Ingatlan hirdetés felvitele"
          : "Ingatlan hirdetés módosítása"}
      </ModalHeader>
      <ModalBody>
        <div className="row">
          ...
          <div className="col-md-4">
            <RVFormGroup>
              ...
              <RVInput
                ...
                name="feladoNev"
                id="feladoNev"
                value={hirdeto.feladoNev}
                onChange={(e) => handleInputChange(e, hirdeto, setHirdeto)}
              />
              <RVFormFeedback />
            </RVFormGroup>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <RVFormGroup>
              ...
              <RVInput
                ...
                onChange={(e) =>
                  handleInputChange(e, ingatlanObj, setIngatlanObj)
                }
              >
          ...
          <div className="col-md-4" hidden={isRendeltetesHidden()}>
            <RVFormGroup>
              <Label>
                {isRequired("Rendeltetés:", !isRendeltetesHidden())}
              </Label>
              <RVInput
        ...
        <div className="row">
          ...
          <div className="col-md-4" hidden={ingatlanObj.statusz !== "Kiadó"}>
            <RVFormGroup>
              <Label>
                {isRequired("Kaució:", ingatlanObj.statusz === "Kiadó")}
              </Label>
              <RVInput
        ...
        <div className="row" hidden={isIngatlanAdatokHidden()}>
          ...
          <div className="col-md-4">
            <RVFormGroup>
              <Label>
                {isRequired("Alapterület:", !isIngatlanAdatokHidden())}
              </Label>
              <RVInputGroup>
                <RVInput
          ...
          <div className="col-md-4">
            <Label>
              {isRequired("Építés módja:", !isIngatlanAdatokHidden())}
            </Label>
            <RVInput
              required={!isIngatlanAdatokHidden()}
              type="select"
        ...
        <div className="row" hidden={isTelekAdatokHidden()}>
          ...
          <div className="col-md-4">
            <RVFormGroup>
              <Label>
                {isRequired("Telek tipus:", !isTelekAdatokHidden())}
              </Label>
              <RVInput
          ...
          <div className="col-md-4">
            <RVFormGroup>
              <Label>
                {isRequired("Telek mérete:", !isTelekAdatokHidden())}
              </Label>
              <RVInputGroup>
                <RVInput
                  required={!isTelekAdatokHidden()}
